...
Предмет исследования: это методы, возможности и преимущества Beamer по сравнению с другими инструментами, такими как PowerPoint, для создания научных презентаций[@beamer-userguide; @lab-task; @overleaf-beamer-images].
